...
import Youmayalsolike from "../homepage/Youmayalsolike";


export async function getmostpopular() {
  try {
    const response = await fetch(
      `${ADMINURL}/wp-json/wp/v2/posts?_embed&order=desc&orderby=date&per_page=4&page=2`,
      { next: { revalidate: 30 } }
    );
    if (!response.ok) {
  ...
  return (
    <footer  >
      <div className="max-w-[1280px] mx-auto">
        <div className="lg:flex space-x-4 mx-4 mt-14 mb-2">
          <section className="lg:w-[35%]" >
            <Mostpopular data={mostpopular} />
          </section>
          <section className="lg:w-[65%]">
            <Youmayalsolike data={alsolike} />
          </section>
        </div>
      </div>
      <div class="bg-[#212121] text-white">
        ...
        <Link href={'/Contact'}>
          <div className="fixed animate-pulse bottom-0 right-0 p-3 bg-red-500 m-5 rounded-full cursor-pointer hover:bg-red-600">
        ...
        <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              {/* <img src="/logo.png" class="mr-5 h-20" alt="logo" /> */}
              <h2 className="text-4xl font-title">Lazzyreaders</h2>
            ...
            <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
              <div>
                ...
                <nav class="flex flex-col mt-4 space-y-2 text-sm">
                  ...
                  <Link class="hover:opacity-75" href="/Contact">
                    Contact Us
                  </Link>
                </nav>
              </div>
              ...
              <div>
                <p class="font-medium text-lg">Legal</p>
                <nav class="flex flex-col mt-4 space-y-2 text-sm ">
                  <a class="hover:opacity-75" href>
                    Privacy Policy
                  </a>
